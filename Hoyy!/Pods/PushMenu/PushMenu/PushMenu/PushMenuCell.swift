...
class PushMenuCell: UIView {
        ...
        struct style {
            ...
            struct light {
                ...
                struct colors {
                    ...
                    static let lightRed = UIColor(red: 255.0/255.0, green: 121.0/255.0, blue: 129.0/255.0, alpha: 0.6)
                    static let lightGreen = UIColor(red:0.85, green:0.13, blue:1.00, alpha:1.0)
                }
                ...
                struct normal {
                    ...
                    struct selected {
                        static let backgroundColor = colors.lightGreen
    ...
    func drawCurvedString(text: String, context: CGContext, radius: CGFloat, angle: CGFloat, color: UIColor, font: UIFont, clockwise: Bool) {
        ...
        for i in 0 ..< text.count {
            arcs += [2 * asin(characters[i].size(withAttributes: attributes).width / (2 * radius))]
            totalArc += arcs[i]
        }
